...
sql_generation_prompt = PromptTemplate.from_template(
    """You are a PostgreSQL expert. Your ONLY job is to write a single, valid
...
WHERE g.name ILIKE '%%ARK%%Survival%%'
GROUP BY g.name
LIMIT 1;
